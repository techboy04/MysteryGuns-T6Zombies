...
CoD.PrivateGameLobby.MysteryGunsOptions = {}
CoD.PrivateGameLobby.MysteryGunsOptions[1] = {}
CoD.PrivateGameLobby.MysteryGunsOptions[1].id = "enable_mysteryguns"
CoD.PrivateGameLobby.MysteryGunsOptions[1].name = "ENABLE MYSTERY GUNS"
CoD.PrivateGameLobby.MysteryGunsOptions[1].hintText = "Toggle the gamemode."
CoD.PrivateGameLobby.MysteryGunsOptions[1].labels = {}
CoD.PrivateGameLobby.MysteryGunsOptions[1].labels[1] = "ENABLED"
CoD.PrivateGameLobby.MysteryGunsOptions[1].labels[2] = "DISABLED"
CoD.PrivateGameLobby.MysteryGunsOptions[1].values = {}
CoD.PrivateGameLobby.MysteryGunsOptions[1].values[1] = 1
CoD.PrivateGameLobby.MysteryGunsOptions[1].values[2] = 0
CoD.PrivateGameLobby.MysteryGunsOptions[1].maps = {}
CoD.PrivateGameLobby.MysteryGunsOptions[1].maps[1] = "zm_transit"
CoD.PrivateGameLobby.MysteryGunsOptions[1].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.MysteryGunsOptions[1].maps[3] = "zm_buried"
CoD.PrivateGameLobby.MysteryGunsOptions[1].maps[4] = "zm_prison"
CoD.PrivateGameLobby.MysteryGunsOptions[1].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.MysteryGunsOptions[1].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.MysteryGunsOptions[1].gameTypes = {}
CoD.PrivateGameLobby.MysteryGunsOptions[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.MysteryGunsOptions[1].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.MysteryGunsOptions[2] = {}
CoD.PrivateGameLobby.MysteryGunsOptions[2].id = "mysteryguns_sharpshooter"
CoD.PrivateGameLobby.MysteryGunsOptions[2].name = "SHARPSHOOTER MODE"
CoD.PrivateGameLobby.MysteryGunsOptions[2].hintText = "Toggle Sharpshooter mode. Must enable Mystery Guns. Instead of every round, guns will switch after a duration."
CoD.PrivateGameLobby.MysteryGunsOptions[2].labels = {}
CoD.PrivateGameLobby.MysteryGunsOptions[2].labels[1] = "ENABLED"
CoD.PrivateGameLobby.MysteryGunsOptions[2].labels[2] = "DISABLED"
CoD.PrivateGameLobby.MysteryGunsOptions[2].values = {}
CoD.PrivateGameLobby.MysteryGunsOptions[2].values[1] = 1
CoD.PrivateGameLobby.MysteryGunsOptions[2].values[2] = 0
CoD.PrivateGameLobby.MysteryGunsOptions[2].maps = {}
CoD.PrivateGameLobby.MysteryGunsOptions[2].maps[1] = "zm_transit"
CoD.PrivateGameLobby.MysteryGunsOptions[2].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.MysteryGunsOptions[2].maps[3] = "zm_buried"
CoD.PrivateGameLobby.MysteryGunsOptions[2].maps[4] = "zm_prison"
CoD.PrivateGameLobby.MysteryGunsOptions[2].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.MysteryGunsOptions[2].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.MysteryGunsOptions[2].gameTypes = {}
CoD.PrivateGameLobby.MysteryGunsOptions[2].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.MysteryGunsOptions[2].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.MysteryGunsOptions[3] = {}
CoD.PrivateGameLobby.MysteryGunsOptions[3].id = "sharpshooter_duration"
CoD.PrivateGameLobby.MysteryGunsOptions[3].name = "SHARPSHOOTER DURATION"
CoD.PrivateGameLobby.MysteryGunsOptions[3].hintText = "How long between each weapon switch."
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels = {}
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[1] = "5"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[2] = "10"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[3] = "15"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[4] = "20"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[5] = "25"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[6] = "30"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[7] = "35"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[8] = "40"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[9] = "45"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[10] = "50"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[11] = "55"
CoD.PrivateGameLobby.MysteryGunsOptions[3].labels[12] = "60"
CoD.PrivateGameLobby.MysteryGunsOptions[3].values = {}
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[1] = 5
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[2] = 10
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[3] = 15
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[4] = 20
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[5] = 25
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[6] = 30
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[7] = 35
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[8] = 40
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[9] = 45
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[10] = 50
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[11] = 55
CoD.PrivateGameLobby.MysteryGunsOptions[3].values[12] = 60
CoD.PrivateGameLobby.MysteryGunsOptions[3].maps = {}
CoD.PrivateGameLobby.MysteryGunsOptions[3].maps[1] = "zm_transit"
CoD.PrivateGameLobby.MysteryGunsOptions[3].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.MysteryGunsOptions[3].maps[3] = "zm_buried"
CoD.PrivateGameLobby.MysteryGunsOptions[3].maps[4] = "zm_prison"
CoD.PrivateGameLobby.MysteryGunsOptions[3].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.MysteryGunsOptions[3].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.MysteryGunsOptions[3].gameTypes = {}
CoD.PrivateGameLobby.MysteryGunsOptions[3].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.MysteryGunsOptions[3].gameTypes[2] = "zstandard"
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		-- 	PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		-- end
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.MysteryGunsOptions, "dvar")
