...
CoD.InitArchiveDvars = function()
	if UIExpression.DvarString(nil, "enable_mysteryguns") == "" then
		Engine.Exec(nil, "seta enable_mysteryguns 1")
	end
	if UIExpression.DvarString(nil, "mysteryguns_sharpshooter") == "" then
		Engine.Exec(nil, "seta mysteryguns_sharpshooter 0")
	end
