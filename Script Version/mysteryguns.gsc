...
main()
{
	create_dvar("enable_mysteryguns", 1);
	create_dvar("mysteryguns_sharpshooter", 0);
...
roll_weapon_on_round_over()
{
	for(;;)
	{
		if(getDvarInt("mysteryguns_sharpshooter") == 1)
		{
...
startHUDMessage()
{
	...
	if(getDvarInt("mysteryguns_sharpshooter") == 1)
	{
		hud3 settext("Weapons roll every few seconds. If weapon is upgraded, the next will be upgraded aswell.");
	}
	else
	{
